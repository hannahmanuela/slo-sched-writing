...
\newcommand\fk[1]{\textcolor{green!55!blue}{[fk: {#1}]}}
\newcommand\rtm[1]{\textcolor{blue!55!blue}{[rtm: {#1}]}}
...
\newcommand{\sys}{FastClass}
\newcommand{\Sys}{FastClass}

\newcommand{\class}{price-class}
\newcommand{\Class}{Price-class}
\newcommand{\priceclass}{price-class}
\newcommand{\Priceclass}{Price-class}

\newcommand{\problem}{crowding problem}
