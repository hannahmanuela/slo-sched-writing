...
The default scheduling policy is \schednormal{}.\hmng{do I need to introduce
scheduling classes here too? a bit of a slippery slope, since that begs the
question of why not use one of those\dots}
