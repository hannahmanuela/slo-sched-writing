...
\subsection{The \cgroups{} interface}\label{ss:intro-cgroups}
...
\hmng{Ana made a good point, which is that she asked what other OSs do. A quick
look at the OCI for Windows shows they also use the same interface of shares and
max, I could talk about that here, and/or make a separate section for other OSs}
