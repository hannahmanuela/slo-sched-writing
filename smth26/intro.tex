...
can make use of otherwise idle resources.  Kubernetes provides these
three service classes for pods~\cite{kubernetes-pod-qos-types}, which
are named BestEffort, Guaranteed, and Burstable. AWS similarly
supports both guaranteed- and burstable-style reservations, with their
M and T instance types~\cite{aws-ec2-burstable,aws-ec2-resources}.
