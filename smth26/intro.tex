...
\begin{enumerate}
    ...
    and be able to resume execution normally after,\hmng{are we introducing the
    parked state? is this what we are showing about it? that it works, maybe
    also that it is desirable?}
