...
need to be allowed to use all of the resources.\hmng{can we take this for
granted? I put a forward ref to the eval in the intro b/c we don't prove this
here, although we could} The goal, then, is to do so without forcing the
