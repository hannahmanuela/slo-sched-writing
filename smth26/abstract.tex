...
utilization. The \cgroups{} implementation must ensure, however, that
...
{\it decentralized} design: it accounts \cgroups{} on a per-core basis, and doesn't
consult other cores' runqueues when making a scheduling decision.

This paper introduces \sys{}, a new scheduler with {\it centralized
