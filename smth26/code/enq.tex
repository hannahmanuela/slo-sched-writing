...
\PY{k+kt}{void}\PY{+w}{ }\PY{n+nf}{enq\PYZus{}proc\PYZus{}vt}\PY{p}{(}\PY{k}{struct}\PY{+w}{ }\PY{n+nc}{process}\PY{+w}{ }\PY{o}{*}\PY{n}{p}\PY{p}{,}\PY{+w}{ }\PY{k}{struct}\PY{+w}{ }\PY{n+nc}{heap}\PY{+w}{ }\PY{o}{*}\PY{n}{h}\PY{p}{)}\PY{+w}{ }\PY{p}{\PYZob{}}
...
\PY{+w}{  }\PY{n}{p}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{vruntime}\PY{+w}{ }\PY{o}{=}\PY{+w}{ }\PY{n}{my\PYZus{}vt}\PY{p}{;}
\PY{+w}{  }\PY{n}{add\PYZus{}process}\PY{p}{(}\PY{n}{p}\PY{p}{,}\PY{+w}{ }\PY{n}{h}\PY{p}{)}\PY{p}{;}
\PY{p}{\PYZcb{}}
\end{Verbatim}
