...
low \class{} jobs will get placed if they have waited for a while.\hmng{why are
we being fair-ish here when we're so unfair everywhere else? maybe just remove?}
...
% It is desirable to have a maximally heterogenous set of \class{}es on each
