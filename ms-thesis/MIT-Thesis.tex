...
\Author{Hannah Manuela Nelle Gross}{Department of Electrical Engineering and Computer Science}[Sc.B., Brown University, 2023]
...
\Supervisor{M. Frans Kaashoek}{Professor of Electrical Engineering and Computer Science}

% Professor who formally accepts theses for your department (e.g., the Graduate Officer, Professor Sméagol,...)
% If more than one department, use more than once
\Acceptor{Leslie A. Kolodziejski}{Professor of Electrical Engineering and Computer Science}{Chair, Department Committee on Graduate Students} % \\ \> Third title}
