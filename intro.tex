...
\hmng{alternatively could phrase the last part where we talk about us as centered 
around getting rid of both type of resource requirements/two different challenges
to which the answers are priorities and paging: compute we get rid of by replacing 
with priority, which is arguably simpler and more effective; and memory we get rid 
of by doing priority-based paging/swapping }
