...
% always seem more important than others': if given an absolute scale, they will
% always choose the highest priority value for their highest priority job.
% However, that does not reflect that in fact different clients do have different
% requirements and expectations, and need to be treated differently.
